...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        final String[] PUBLIC_ENDPOINTS = { "/auth/login","/api/v1/ ","/api/v1/person/upload","/api/v1/upload","/api/v1/download", "/auth/introspect" ,"/api/v1/role","/api/v1/role/upload", "/api/v1/permission" };
